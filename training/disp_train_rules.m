function [ rules ] = disp_train_rules( train,Ethresh,h0 )
%TO BE USED TO DISPLAY RULES ONLY!!!!!!!!!!!!!!!!!!!!!!!

%determines rule set from quantized set of training data
% where the first column of train is the class
...
for order=2:numf
    ...
    for i=1:size(combos,1)
        ...
        for c=1:numc
            ...
            rX=disp_calc_rule(s_train,CLASS,alpha,combos_c,Ethresh,h0,prior); %pdf of features with class
            rules=[rules;rX];
        end;
    end;
end;
